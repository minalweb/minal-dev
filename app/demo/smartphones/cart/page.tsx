...
export default function SmartphoneCart() {
  return (
    <main className="section-padding">
      <div className="mx-auto max-w-4xl space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <h1 className="text-3xl font-semibold">Your Cart</h1>
          <Link href="/demo/smartphones/products" className="secondary-button">
            Continue Shopping
          </Link>
        </div>
        ...
        <div className="glass-card flex flex-wrap items-center justify-between gap-4 p-6">
          <div>
            ...
            <p className="text-2xl font-semibold">$1,998</p>
          </div>
