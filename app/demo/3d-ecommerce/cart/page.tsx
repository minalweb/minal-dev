    ...
    return (
      <main className="section-padding">
        <div className="mx-auto max-w-3xl space-y-6 text-center">
          ...
          <p className="text-white/60">Explore the neon lineup and build your bundle.</p>
      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="glass-card divide-y divide-white/10">
          {lines.map((line) => (
            <div key={line.product.id} className="flex flex-wrap items-center gap-4 p-5">
              <img src={line.product.image} alt={line.product.name} className="h-16 w-16 object-contain" />
        ...
        <div className="glass-card flex flex-wrap items-center justify-between gap-4 p-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link href="/demo/3d-ecommerce/checkout" className="primary-button">
              Checkout
            </Link>
          </div>
        </div>
