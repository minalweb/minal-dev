...
export default function AccessoriesCheckout() {
    ...
    return (
      <main className="section-padding">
        <div className="mx-auto max-w-3xl space-y-6 text-center">
          ...
          <p className="text-white/60">Add accessories to your cart before placing an order.</p>
    ...
    <main className="section-padding">
      <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="glass-card p-6">
          ...
          <p className="mt-2 text-sm text-white/60">Complete your delivery details.</p>
          ...
          >
            ...
            {submitted && (
              <p className="text-sm text-accent-400">
                Order received. We will confirm your delivery by phone.
              </p>
            )}
          </form>
        </div>
        ...
        <div className="glass-card p-6">
          ...
          <Link href="/demo/accessories/cart" className="mt-6 inline-flex text-sm text-white/60 hover:text-white">
            ← Return to cart
          </Link>
        </div>
      </div>
